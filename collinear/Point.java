...
public class Point implements Comparable<Point> {
    ...
    private class PointComparator implements Comparator<Point> {
        ...
        public int compare(Point x, Point y) {
            double slope1 = x.slopeTo(point);
            double slope2 = y.slopeTo(point);
            if (slope1 == slope2) {
                return 0;
    ...
    public static void main(String[] args) {
        ...
        Comparator pointCompP1 = p1.slopeOrder();
        int compareP1 = pointCompP1.compare(p2, p3);
        System.out.println(compareP1);
        Point p4 = new Point(14, 302);
        Point p5 = new Point(190, 59);
        System.out.println(p4.slopeTo(p5));
        System.out.println((302 - 59) / (14 - 190));
    }
